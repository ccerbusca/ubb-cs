...
The application is an image managing tool. The user is able to create new entries that describe images, meaning: uploading an image, giving it a title and adding tags to it that he can later filter by when searching. Main screen will show a list of all the images, their tags and a preview of the image itself. Clicking on the image maximises it.
